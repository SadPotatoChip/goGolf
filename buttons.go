...
// (300, 100), (600, 200) predji na drugi nivo
	if x_pos > 50 && x_pos < 270 && y_pos > 200 && y_pos < 360 && (is_main_menu == false) && lev == true && mouseButtonDown(ebiten.MouseButtonLeft) {
		fmt.Println("predji na drugi nivo")
		set_first_level()
		}

// (300, 100), (600, 200) predji na drugi nivo
	if x_pos > 270 && x_pos < 490 && y_pos > 200 && y_pos < 360 && (is_main_menu == false) && lev == true && mouseButtonDown(ebiten.MouseButtonLeft) {
		fmt.Println("predji na drugi nivo")
		set_second_level()
		}
// (300, 100), (600, 200) predji na drugi nivo
	if x_pos > 490 && x_pos < 710 && y_pos > 200 && y_pos < 360 && (is_main_menu == false) && lev == true && mouseButtonDown(ebiten.MouseButtonLeft) {
		fmt.Println("predji na drugi nivo")
		set_third_level()
		}
// (300, 100), (600, 200) predji na drugi nivo
	if x_pos > 710 && x_pos < 930 && y_pos > 200 && y_pos < 360 && (is_main_menu == false) && lev == true && mouseButtonDown(ebiten.MouseButtonLeft) {
		fmt.Println("predji na drugi nivo")
		set_forth_level()
		}
// (300, 100), (600, 200) predji na drugi nivo
	if x_pos > 930 && x_pos < 1150 && y_pos > 200 && y_pos < 360 && (is_main_menu == false) && lev == true && mouseButtonDown(ebiten.MouseButtonLeft) {
		fmt.Println("predji na drugi nivo")
		set_fifth_level()
		}
// next
